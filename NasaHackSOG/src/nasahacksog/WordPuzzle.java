...
public class WordPuzzle implements ActionListener {
    ...
    private boolean check() {
        ...
        else stringlength(1,3,11,col);
        if (response[6].toLowerCase().compareTo(down[1]) != 0) {
            correction(6);
            correct = false;
        }
        else stringlength(28,7,11,col);
        individualCheck();
        return correct;
    }
    ...
    public void setTextArea() {
        ...
        area.insert("Across 1: A star that shines brightly before it slowly fades away. Also known as a \nnew bright star."
                ...
                + "\nAcross 3: The universe orcosmos in \nspace"
    ...
    private void correction(int i)
    {
        ...
        {
            case 0:
            {stringlength(1,9,1,Color.RED);break;}
            case 1:
            {stringlength(23,6,1,Color.RED);break;}
            case 2:
            {stringlength(49,6,1,Color.RED);break;}
            case 3:
            {stringlength(70,5,1,Color.RED);break;}
            case 4:
            {stringlength(88,6,1,Color.RED);break;}
            case 5:
            {stringlength(1,3,11,Color.RED);break;}
            case 6:
            {stringlength(28,7,11,Color.RED);break;}
        }
    }
    @Override
